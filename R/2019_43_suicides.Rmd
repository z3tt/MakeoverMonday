...
theme_update(axis.ticks = element_line(size = 0.1, color = "grey40"),
             ...
             plot.title = element_markdown(size = 22, color = "grey80", hjust = 0.5,
                                           margin = margin(b = 20)),
             plot.subtitle = element_text(size = 15, color = "grey60", 
...
cols <- c("grey70", "#764786", "#764786")  ## #364bb7 #9900cd
```
...
dotplot <-
  ...
  ggplot(aes(born, count, color = highlight)) +
    ...
    labs(x = NULL, y = "Suicides per recorded year",
         title = "People <span style='color:#764786'>born in the 60s</span> are most likely to die by suicide and drug poisoning.",
         subtitle = "Deaths registered in England and Wales between 1981 and 2017 by year of birth (top)\nas well as over time splitted by decade born (center; not all shown) and age class (bottom).\n\n")
```
...
ggsave(here::here("plots", "2019_43_suicides.png"), 
